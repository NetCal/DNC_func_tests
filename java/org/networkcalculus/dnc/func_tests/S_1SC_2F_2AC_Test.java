...
import org.networkcalculus.dnc.func_tests.S_1SC_2F_2AC_Results;
import org.networkcalculus.dnc.func_tests.S_1SC_2F_2AC_ServerGraph;
...
public class S_1SC_2F_2AC_Test extends DncTest {
	private static S_1SC_2F_2AC_ServerGraph network_factory = new S_1SC_2F_2AC_ServerGraph();
	private static ServerGraph network = network_factory.getServerGraph();
	private Flow f0, f1;

	private S_1SC_2F_2AC_Test() throws Exception {
		super(network_factory, new S_1SC_2F_2AC_Results());
