...
public class TA_3S_1SC_3F_1AC_3P_ServerGraph implements ServerGraphFactory {
	...
	public TA_3S_1SC_3F_1AC_3P_ServerGraph() {
	...
	public ServerGraph createServerGraph() {
		...
		try {
			...
			server_graph.addFlow("f1", arrival_curve, s2);
			server_graph.addFlow("f2", arrival_curve, s0, s2);
		} catch (Exception e) {
			e.printStackTrace();
			throw new RuntimeException(e);
		}
